...
const Home: React.FC = () => {
  ...
  return (
    <div className=" bg-[url('/chatBot/gptbg.png')] max-lg:bg-[url('/chatBot/wallpaper.png')] max-lg:bg-[bottom_center] h-[100vh] bg-cover flex flex-row justify-around overflow-hidden ">
      <KirbyAnimation />
