      ...
      <div className="flex flex-col items-center bg-[#E3E9FC] h-[100vh]">
        ...
        <div className="flex flex-col">
          <p>
            ...
            I first appeared in *Kirby&apos;s Dream Land* in 1992 and have since
            been in over 50 games, exploring different genres like platformers,
            racing, and even pinball. I&apos;m known for my pink, round body,
            and my ability to inhale enemies and take on their abilities, which
            makes me super versatile in my adventures.
          </p>
          <p>
            ...
            Ya!* People love me for my cuteness and my fun, easy-to-draw design.
            Whether I&apos;m flying, fighting, or just eating, I&apos;m always
            up for an adventure!
          </p>
        </div>
      </div>
